...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection sell_pay_log_id
     * @property Grid\Column|Collection invoice_no
     * @property Grid\Column|Collection invoice_at
     ...
     * @property Grid\Column|Collection to_url
     ...
     * @method Grid\Column|Collection sell_pay_log_id(string $label = null)
     * @method Grid\Column|Collection invoice_no(string $label = null)
     * @method Grid\Column|Collection invoice_at(string $label = null)
     ...
     * @method Grid\Column|Collection to_url(string $label = null)
     ...
     * @property Show\Field|Collection sell_pay_log_id
     * @property Show\Field|Collection invoice_no
     * @property Show\Field|Collection invoice_at
     ...
     * @property Show\Field|Collection to_url
     ...
     * @method Show\Field|Collection sell_pay_log_id(string $label = null)
     * @method Show\Field|Collection invoice_no(string $label = null)
     * @method Show\Field|Collection invoice_at(string $label = null)
     ...
     * @method Show\Field|Collection to_url(string $label = null)
